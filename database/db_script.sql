...
CREATE TABLE IF NOT EXISTS `Dev_Cloud_db`.`Users` (
  ...
  `picture` BLOB NULL,
  `last_activity_date` DATE NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `Dev_Cloud_db`.`Template_instances` (
  `template_id` INT(11) NOT NULL DEFAULT AUTO_INCREEMNT,
...
CREATE TABLE IF NOT EXISTS `Dev_Cloud_db`.`Installed_applications` (
  `installed_app_id` INT(11) NOT NULL DEFAULT AUTO_INCREMENT,
