...
ERRORS = {
    ...
    'vm_cannot_shutdown': _(
        'Error: shutting down virtual machine failed. Please shutdown your machine from the machine\'s operating system.'),
...
MESSAGE_CODES = {
    ...
    'group_request': _(
        '<em>%(first_name)s %(last_name)s</em> wants to join to group <a href="%(grp_details_url)s"> <b>%(group_name)s</b></a>.'),
