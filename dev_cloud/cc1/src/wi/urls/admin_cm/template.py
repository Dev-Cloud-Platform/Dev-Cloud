...
template_patterns = patterns('wi.views.admin_cm.template',
                             url(r'^templates/$', admin_cm_permission(direct_to_template),
                                 {'template_name': 'admin_cm/templates.html'}, name='cma_templates'),
                             url(r'^ajax/get_table_templates/$', 'cma_ajax_get_table_templates',
                             ...
                             url(r'^ajax/delete_template/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                                 {'template_name': 'generic/simple.html',
                                  'success_msg': (
                                  lambda desc: _('You have successfully deleted template <b>%(desc)s</b>.') % {
                                      'desc': desc}),
                                  'ask_msg': (
                                  lambda desc: _('Do you want to delete template <b>%(desc)s</b>?') % {'desc': desc}),
                             ...
                             url(r'^ajax/add_template/$', admin_cm_permission(form_generic),
                                 {'template_name': 'generic/form.html',
                                  'success_msg': (
                                  lambda desc, data: _('You have successfully created a template.') % {'desc': desc}),
                             ...
                             url(r'^ajax/edit_template/(?P<id1>\d+)/$', admin_cm_permission(form_generic_id),
                                 {'template_name': 'generic/form.html',
                                  'success_msg': (
                                  lambda desc, data: _('You have successfully edited selected template.') % {
                                      'desc': desc}),
                                  'confirmation': _('Save'),
