...
image_patterns = patterns('wi.views.admin_cm.system_image',
                          url(r'^images/$', admin_cm_permission(direct_to_template),
                              {'template_name': 'admin_cm/images.html'}, name='cma_images'),
                          url(r'^ajax/get_table_images/$', 'cma_ajax_get_table_images',
                              name='cma_ajax_get_table_images'),
                          ...
                          url(r'^ajax/edit_image/(?P<id1>\d+)/$', admin_cm_permission(form_generic_id),
                              {'template_name': 'generic/form.html',
                               'success_msg': (
                               lambda desc, data: _('You have successfully edited selected image.') % {'desc': desc}),
                               'confirmation': _('Save'),
                          ...
                          url(r'^ajax/cm/delete_image/$', admin_cm_permission(generic_multiple_id),
                              {'template_name': 'generic/simple.html',
                               'success_msg': (
                               lambda desc, count: ungettext('You have successfully deleted image <b>%(desc)s</b>.',
                                                             'You have successfully deleted %(count)d images (<b>%(desc)s</b>).',
                                                             count) % {'desc': desc, 'count': count}),
                               'ask_msg': (lambda desc, count: ungettext('Do you want to delete image <b>%(desc)s</b>?',
                                                                         'Do you want to delete %(count)d images <b>%(desc)s</b>?',
                                                                         count) % {'desc': desc, 'count': count}),
                          ...
                          url(r'^ajax/private_image/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                              {'template_name': 'generic/simple.html',
                               'success_msg': (
                               lambda desc: _('You have successfully changed type of image <b>%(desc)s</b>.') % {
                                   'desc': desc}),
                               'ask_msg': (
                          ...
                          url(r'^ajax/public_image/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                              {'template_name': 'generic/simple.html',
                               ...
                               lambda desc: _('You have successfully changed type of image <b>%(desc)s</b>.') % {
                                   'desc': desc}),
                               'ask_msg': (
                               lambda desc: _('Do you want to make image <b>%(desc)s</b> public?') % {'desc': desc}),
