...
iso_patterns = patterns('wi.views.admin_cm.iso_image',
                        url(r'^iso/$', admin_cm_permission(direct_to_template), {'template_name': 'admin_cm/iso.html'},
                            name='cma_iso'),
                        ...
                        url(r'^ajax/edit_iso/(?P<id1>\d+)/$', admin_cm_permission(form_generic_id),
                            {'template_name': 'generic/form.html',
                             'success_msg': (
                             lambda desc, data: _('You have successfully edited selected ISO image.') % {'desc': desc}),
                             'confirmation': _('Save'),
                        ...
                        url(r'^ajax/delete_iso/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                            {'template_name': 'generic/simple.html',
                             'success_msg': (
                             lambda desc: _('You have successfully deleted ISO image <b>%(desc)s</b>.') % {
                                 'desc': desc}),
                             'ask_msg': (
                             lambda desc: _('Do you want to delete ISO image <b>%(desc)s</b>?') % {'desc': desc}),
