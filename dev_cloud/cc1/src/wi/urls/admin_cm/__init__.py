...
urlpatterns = patterns('',
                       url(r'^admin_cm/$', admin_cm_permission(direct_to_template),
                           {'template_name': 'admin_cm/base.html'}, name='cma_admin'),
                       url(r'^ajax/move_database/$', admin_cm_permission(simple_generic),
                           {'template_name': 'generic/simple.html',
                            'success_msg': (
                            lambda desc: _('You have successfully moved data to archival database.') % {'desc': desc}),
                            'ask_msg': (
                            lambda desc: _('Do you want to move data to archival database?') % {'desc': desc}),
