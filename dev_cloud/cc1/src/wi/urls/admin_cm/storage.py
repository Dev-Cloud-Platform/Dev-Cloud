...
storage_patterns = patterns('wi.views.admin_cm.storage',
                            url(r'^storages/$', admin_cm_permission(direct_to_template),
                                {'template_name': 'admin_cm/storages.html'}, name='cma_storages'),
                            url(r'^ajax/get_table_storages/$', 'cma_ajax_get_table_storages',
                                name='cma_ajax_get_table_storages'),
                            url(r'^ajax/add_storage/$', admin_cm_permission(form_generic),
                                {'template_name': 'generic/form.html',
                                 'success_msg': (
                                 lambda desc, data: _('You have successfully created a storage.') % {'desc': desc}),
                            ...
                            url(r'^ajax/lock_storage/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                                {'template_name': 'generic/simple.html',
                                 'success_msg': (
                                 lambda desc: _('You have successfully locked storage <b>%(desc)s</b>.') % {
                                     'desc': desc}),
                                 'ask_msg': (
                                 lambda desc: _('Do you want to lock storage <b>%(desc)s</b>?') % {'desc': desc}),
                            ...
                            url(r'^ajax/delete_storage/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                                {'template_name': 'generic/simple.html',
                                 'success_msg': (
                                 lambda desc: _('You have successfully deleted storage <b>%(desc)s</b>.') % {
                                     'desc': desc}),
                                 'ask_msg': (
                                 lambda desc: _('Do you want to delete storage <b>%(desc)s</b>?') % {'desc': desc}),
                            ...
                            url(r'^ajax/unlock_storage/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                                {'template_name': 'generic/simple.html',
                                 'success_msg': (
                                 lambda desc: _('You have successfully unlocked storage <b>%(desc)s</b>.') % {
                                     'desc': desc}),
                                 'ask_msg': (
                                 lambda desc: _('Do you want to unlock storage <b>%(desc)s</b>?') % {'desc': desc}),
                                 'request_url': 'admin_cm/storage/unlock/',
                                 'id_key': 'storage_id', },
                                name='cma_ajax_unlock_storage'),
                            url(r'^ajax/mount_node/(?P<storage_id>\d+)/$', 'cma_ajax_mount_node',
                                name='cma_ajax_mount_node'),

                            url(r'^ajax/mount_rm/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                                {'template_name': 'generic/simple.html',
                                 'success_msg': (
                                 lambda desc: _('You have successfully mounted strorage to RM.') % {'desc': desc}),
