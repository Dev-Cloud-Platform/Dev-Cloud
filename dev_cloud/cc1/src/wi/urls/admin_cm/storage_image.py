...
disk_patterns = patterns('wi.views.admin_cm.storage_image',
                         url(r'^disks/$', admin_cm_permission(direct_to_template),
                             {'template_name': 'admin_cm/disks.html'}, name='cma_disks'),
                         ...
                         url(r'^ajax/edit_disk/(?P<id1>\d+)/$', admin_cm_permission(form_generic_id),
                             {'template_name': 'generic/form.html',
                              'success_msg': (
                              lambda desc, data: _('You have successfully edited selected disk.') % {'desc': desc}),
                              'confirmation': _('Save'),
                         ...
                         url(r'^ajax/delete_disk/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully deleted disk volume <b>%(desc)s</b>.') % {
                                  'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to delete disk volume <b>%(desc)s</b>?') % {'desc': desc}),
                         ...
                         url(r'^ajax/cm/revoke_disk/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully revoked disk volume <b>%(desc)s</b>.') % {
                                  'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to revoke disk volume <b>%(desc)s</b>?') % {'desc': desc}),
