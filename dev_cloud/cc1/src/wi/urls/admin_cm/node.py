...
node_patterns = patterns('wi.views.admin_cm.node',
                         url(r'^nodes/$', admin_cm_permission(direct_to_template),
                             {'template_name': 'admin_cm/nodes.html'}, name='cma_nodes'),
                         url(r'^ajax/get_table_nodes/$', 'cma_ajax_get_table_nodes', name='cma_ajax_get_table_nodes'),
                         url(r'^ajax/node_details/(?P<node_id>\d+)/$', 'cma_ajax_node_details',
                         ...
                         url(r'^ajax/delete_node/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully deleted node <b>%(desc)s</b>.') % {'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to delete node <b>%(desc)s</b>?') % {'desc': desc}),
                         ...
                         url(r'^ajax/cm/lock_node/$', admin_cm_permission(generic_multiple_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc, count: ungettext('You have successfully locked node <b>%(desc)s</b>.',
                                                            'You have successfully locked %(count)d nodes (<b>%(desc)s</b>).',
                                                            count) % {'desc': desc, 'count': count}),
                              'ask_msg': (lambda desc, count: ungettext('Do you want to lock node <b>%(desc)s</b>?',
                                                                        'Do you want to lock %(count)d nodes <b>%(desc)s</b>?',
                                                                        count) % {'desc': desc, 'count': count}),
                         ...
                         url(r'^ajax/cm/check_node/$', admin_cm_permission(generic_multiple_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc, count: ungettext('Node <b>%(desc)s</b> queued for validation.',
                                                            '%(count)d nodes (<b>%(desc)s</b>) queued for validation.',
                                                            count) % {'desc': desc, 'count': count}),
                              'ask_msg': (lambda desc, count: ungettext('Do you want to validate node <b>%(desc)s</b>?',
                                                                        'Do you want to validate %(count)d nodes <b>%(desc)s</b>?',
                                                                        count) % {'desc': desc, 'count': count}),
                         ...
                         url(r'^ajax/hardlock_node/(?P<id1>\d+)/$', admin_cm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully hardlocked node <b>%(desc)s</b>.') % {
                                  'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to hardlock node <b>%(desc)s</b>?') % {'desc': desc}),
                         ...
                         url(r'^ajax/cm/unlock_node/$', admin_cm_permission(generic_multiple_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc, count: ungettext('You have successfully unlocked node <b>%(desc)s</b>.',
                                                            'You have successfully unlocked %(count)d nodes (<b>%(desc)s</b>).',
                                                            count) % {'desc': desc, 'count': count}),
                              'ask_msg': (lambda desc, count: ungettext('Do you want to unlock node <b>%(desc)s</b>?',
                                                                        'Do you want to unlock %(count)d nodes <b>%(desc)s</b>?',
                                                                        count) % {'desc': desc, 'count': count}),
                         ...
                         url(r'^ajax/add_node/$', admin_cm_permission(form_generic),
                             {'template_name': 'generic/form.html',
                              'success_msg': (
                              lambda desc, data: _('You have successfully created a node.') % {'desc': desc}),
                         ...
                         url(r'^ajax/edit_node/(?P<id1>\d+)/$', admin_cm_permission(form_generic_id),
                             {'template_name': 'generic/form.html',
                              'success_msg': (
                              lambda desc, data: _('You have successfully edited selected node.') % {'desc': desc}),
                              'confirmation': _('Save'),
                         ...
                         url(r'^ajax/create_vm/(?P<id1>\d+)/$', admin_cm_permission(form_generic_id),
                             {'template_name': 'generic/form.html',
                              'success_msg': (lambda desc, data: _(
                              ...
                              'request_url_both': {
                                  ...
                                  'images_private': (
                                  'user/system_image/get_list/', {'access': image_access['private']}),
                         ...
                         url(r'^ajax/mount_storage/(?P<node_id>\d+)/$', 'cma_ajax_mount_storage',
                             name='cma_ajax_mount_storage'),
