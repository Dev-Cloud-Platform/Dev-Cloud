...
vm_patterns = patterns('wi.views.admin_cm.vm',
                       ...
                       url(r'^ajax/cm/vms_get_table/(?P<user_id>\d+)/$', 'cma_vms_ajax_get_table',
                           name='cma_vms_ajax_get_table'),
                       url(r'^ajax/cm/vm_details/(?P<vm_id>\d+)/$', 'cma_vms_ajax_vm_details',
                       ...
                       url(r'^ajax/cm/vm_destroy/$', admin_cm_permission(generic_multiple_id),
                           {'template_name': 'generic/simple.html',
                            ...
                            'ask_msg': (
                            lambda desc, count: ungettext('Do you want to destroy virtual machine <b>%(desc)s</b>?',
                       ...
                       url(r'^ajax/cm/vm_erase/$', admin_cm_permission(generic_multiple_id),
                           {'template_name': 'generic/simple.html',
                            'success_msg': (lambda desc, count: ungettext(
                                ...
                                count) % {'desc': desc, 'count': count}),
                            'ask_msg': (
                            lambda desc, count: ungettext('Do you want to erase virtual machine <b>%(desc)s</b>?',
