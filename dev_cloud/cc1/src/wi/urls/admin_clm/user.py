...
user_patterns = patterns('wi.views.admin_clm.user',
                         ...
                         url(r'^users/$', admin_clm_permission(direct_to_template),
                             {'template_name': 'admin_clm/users.html'}, name='clm_users'),
                         ...
                         url(r'^ajax/activate_user/(?P<id1>\d+)/$', admin_clm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully activated user <b>%(desc)s</b>.') % {'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to activate user <b>%(desc)s</b>?') % {'desc': desc}),
                         ...
                         url(r'^ajax/block_user/(?P<id1>\d+)/$', admin_clm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully blocked user <b>%(desc)s</b>.') % {'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to block user <b>%(desc)s</b>?') % {'desc': desc}),
                         ...
                         url(r'^ajax/unblock_user/(?P<id1>\d+)/$', admin_clm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully unblocked user <b>%(desc)s</b>.') % {'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to unblock user <b>%(desc)s</b>?') % {'desc': desc}),
                              'request_url': 'admin_clm/user/block/',
                              'id_key': 'user_id',
                         ...
                         url(r'^ajax/edit_user_data/(?P<id1>\d+)/$', admin_clm_permission(form_generic_id),
                             {'template_name': 'generic/form.html',
                              'success_msg': (
                              lambda desc, data: _('You have successfully changed account data.') % {'desc': desc}),
                              'confirmation': _('Save'),
                             ...
                             {'template_name': 'generic/simple.html',
                              'success_msg': (lambda desc: _(
                                  'You have successfully changed user <b>%(desc)s</b> to CLM administrator.') % {
                                                               'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to promote user <b>%(desc)s</b> to administrator?') % {
                                  'desc': desc}),
                         ...
                         url(r'^ajax/unset_admin/(?P<id1>\d+)/$', admin_clm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully changed <b>%(desc)s</b> to regular user.') % {
                                  'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to demote administrator <b>%(desc)s</b> to regular user?') % {
                                  'desc': desc}),
                              'request_url': 'admin_clm/user/set_admin/',
                              'id_key': 'user_id',
                              'param': {'admin': False}},
                         ...
                         url(r'^ajax/delete_user/(?P<id1>\d+)/$', admin_clm_permission(simple_generic_id),
                             {'template_name': 'generic/simple.html',
                              'success_msg': (
                              lambda desc: _('You have successfully deleted user <b>%(desc)s</b>.') % {'desc': desc}),
                              'ask_msg': (
                              lambda desc: _('Do you want to delete user <b>%(desc)s</b>?') % {'desc': desc}),
                              'request_url': 'admin_clm/user/delete/',
                              'id_key': 'user_id', },
                             name='clm_ajax_delete_user'),
                         url(r'^ajax/set_password/(?P<id1>\d+)/$', 'clm_ajax_set_password',
                             name='clm_ajax_set_password'),
