...
cm_patterns = patterns('wi.views.admin_clm.cm',
                       url(r'^cms$', admin_clm_permission(direct_to_template), {'template_name': 'admin_clm/cms.html'},
                           name='clm_cms'),
                       ...
                       url(r'^ajax/delete_cm/(?P<id1>\d+)/$', admin_clm_permission(simple_generic_id),
                           {'template_name': 'generic/simple.html',
                            'success_msg': (
                            lambda desc: _('You have successfully deleted CM <b>%(desc)s</b>.') % {'desc': desc}),
                       ...
                       url(r'^ajax/lock_cm/(?P<id1>\d+)/$', admin_clm_permission(simple_generic_id),
                           {'template_name': 'generic/simple.html',
                            'success_msg': (
                            lambda desc: _('You have successfully locked CM <b>%(desc)s</b>.') % {'desc': desc}),
                       ...
                       url(r'^ajax/unlock_cm/(?P<id1>\d+)/$', admin_clm_permission(simple_generic_id),
                           {'template_name': 'generic/simple.html',
                            'success_msg': (
                            lambda desc: _('You have successfully unlocked CM <b>%(desc)s</b>.') % {'desc': desc}),
                       ...
                       url(r'^ajax/add_cm/$', admin_clm_permission(form_generic),
                           {'template_name': 'generic/form.html',
                            'success_msg': (
                            lambda desc, data: _('You have successfully created a CM.') % {'desc': desc}),
                            'ask_msg': (
                            lambda desc: _('Note: currently logged user becomes CM administrator.') % {'desc': desc}),
                       ...
                       url(r'^ajax/edit_cm/(?P<id1>\d+)/$', admin_clm_permission(form_generic_id),
                           {'template_name': 'generic/form.html',
                            'success_msg': (
                            lambda desc, data: _('You have successfully edited selected CM.') % {'desc': desc}),
                            'confirmation': _('Save'),
