...
resources_patterns = patterns('wi.views.user.network',
                              ...
                              url(r'^networks/$', user_permission(direct_to_template),
                                  {'template_name': 'resources/networks.html'}, name='res_networks'),
                              url(r'^ajax/network_table/$', user_permission(get_list_generic),
                                  {'request_url': 'user/network/list_user_networks/'},
                                  name='res_ajax_get_network_table'),
                              url(r'^ajax/add_network/$', user_permission(form_generic),
                                  {'template_name': 'generic/form.html',
                                   'success_msg': (
                                   lambda desc, data: _('You have successfully added a network') % {'desc': desc}),
