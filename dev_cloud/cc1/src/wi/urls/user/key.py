...
resources_patterns = patterns('wi.views.user.key',
                              ...
                              url(r'^keys/$', user_permission(direct_to_template),
                                  {'template_name': 'resources/keys.html'}, name='res_keys'),
                              ...
                              url(r'^ajax/add_key/$', user_permission(form_generic),
                                  {'template_name': 'generic/form.html',
                                   'success_msg': (
                                   lambda desc, data: _('You have successfully added a key') % {'desc': desc}),
                                   'confirmation': _('Add'),
                              ...
                              url(r'^ajax/delete_key/(?P<id1>\d+)/$', user_permission(simple_generic_id),
                                  {'template_name': 'generic/simple.html',
                                   'success_msg': (
                                   lambda desc: _('You have successfully deleted key <b>%(desc)s</b>.') % {
                                       'desc': desc}),
                                   'ask_msg': (lambda desc: _('Do you really want to delete key <b>%(desc)s</b>?') % {
                                       'desc': desc}),
