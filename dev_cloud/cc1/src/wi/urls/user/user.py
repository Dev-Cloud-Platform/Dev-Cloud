...
account_patterns = patterns('wi.views.user.user',
                            url(r'^$', user_permission(direct_to_template), {'template_name': 'account/base.html'},
                                name='acc_account'),
                            url(r'^account_data/$', user_permission(direct_to_template),
                                {'template_name': 'account/account_data.html'}, name='acc_account_data'),

                            url(r'^account_data/ajax/get_user_data/$', 'acc_ajax_get_user_data',
                                name='acc_ajax_get_user_data'),

                            url(r'^account_data/ajax/edit/$', 'acc_ajax_account_data_edit',
                                name='acc_ajax_account_data_edit'),

                            url(r'^account_quotas/$', user_permission(direct_to_template),
                                {'template_name': 'account/account_quotas.html'}, name='acc_account_quotas'),
                            url(r'^account_data/ajax/get_user_quotas/$', 'acc_ajax_get_user_quotas',
...
help_patterns = patterns('wi.views.user.user',
                         ...
                         url(r'^issue_error/$', direct_to_template, {'template_name': 'help/issue_error.html'},
                             name='hlp_issue_error'),
                         url(r'^issue_sent/$', direct_to_template, {'template_name': 'help/issue_sent.html'},
                             name='hlp_issue_sent'),
                         )
