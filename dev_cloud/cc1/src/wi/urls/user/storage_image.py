...
resources_patterns = patterns('wi.views.user.storage_image',
                              ...
                              url(r'^disks/$', user_permission(direct_to_template),
                                  {'template_name': 'resources/disks.html'}, name='res_disks'),
                              url(r'^ajax/disk_table/$', 'res_ajax_get_disk_table', name='res_ajax_get_disk_table'),
                              url(r'^ajax/upload_disk_http/$', 'res_ajax_upload_disk_http',
                                  name='res_ajax_upload_disk_http'),
                              ...
                              url(r'^ajax/edit_disk/(?P<id1>\d+)/$', user_permission(form_generic_id),
                                  {'template_name': 'generic/form.html',
                                   'success_msg': (
                                   lambda desc, data: _('You have successfully edited selected disk.') % {
                                       'desc': desc}),
                              ...
                              url(r'^ajax/delete_disk/(?P<id1>\d+)/$', user_permission(simple_generic_id),
                                  {'template_name': 'generic/simple.html',
                                   'success_msg': (
                                   lambda desc: _('You have successfully removed disk volume <b>%(desc)s</b>.') % {
                                       'desc': desc}),
                                   'ask_msg': (
                                   lambda desc: _('Do you really want to delete disk volume <b>%(desc)s</b>?') % {
                                       'desc': desc}),
                                  ...
                                  {'template_name': 'generic/form.html',
                                   'success_msg': (lambda desc, data: _(
                                       'You have successfully changed disk <b>%(desc)s</b> to a VM image.') % {
                                                                          'desc': desc}),
                                   'ask_msg': (
                                   lambda desc: _('Do you want to change disk <b>%(desc)s</b> to a VM image?') % {
                                       'desc': desc}),
