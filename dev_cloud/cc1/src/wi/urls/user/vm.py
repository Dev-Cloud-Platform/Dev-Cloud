...
vm_patterns = patterns('wi.views.user.vm',
                       url(r'^$', user_permission(direct_to_template), {'template_name': 'vms/base.html'},
                           name='vms_vms'),

                       url(r'^create_vm/$',
                           CreateVMWizard.as_view([CreateVMForm1, CreateVMForm2, CreateVMForm3, CreateVMForm4]),
                           name='vms_create_vm'),
                       url(r'^show_vm/$', user_permission(direct_to_template), {'template_name': 'vms/show_vm.html'},
                           name='vms_show_vm'),
                       ...
                       url(r'^ajax/ssh_key/$', user_permission(generic_multiple_id_form),
                           {'template_name': 'generic/form.html',
                            'success_msg': (
                            lambda desc, count: ungettext('SSH key has been copied successfully to <b>%(desc)s</b>.',
                                                          'SSH key has been copied successfully to %(count)d virtual machines (<b>%(desc)s</b>).',
                                                          count) % {'desc': desc, 'count': count}),
                            'ask_msg': (
                            lambda desc, count: ungettext('Enter a public key to set for machine <b>%(desc)s</b>.',
                                                          'Enter a public key to set for %(count)d machines <b>%(desc)s</b>.',
                                                          count) % {'desc': desc, 'count': count}),
                           ...
                           {'template_name': 'generic/form.html',
                            'success_msg': (lambda desc, data: _(
                                'Password has been set to: (<b>%(password)s</b>) on machine: <b>%(desc)s</b>.') % {
                                                                   'password': data['password'], 'desc': desc}),
                            'ask_msg': (lambda desc: _('Reset machine <b>%(desc)s</b> password for selected user.') % {
                                'desc': desc}),
                       ...
                       url(r'^ajax/destroy/$', user_permission(generic_multiple_id),
                           {'template_name': 'generic/simple.html',
                            ...
                            'ask_msg': (lambda desc, count: ungettext(
                                ...
                                'Do you want to destroy %(count)d virtual machines <b>%(desc)s</b>?<br /><b>Note!</b> If you would like to use this machine later make sure to use the <b>Save and shutdown</b> option instead!<br /> We recommend to manually unmount any attached storage disks.',
                                count) % {'desc': desc, 'count': count}),
                       ...
                       url(r'^ajax/restart/$', user_permission(generic_multiple_id),
                           {'template_name': 'generic/simple.html',
                            'success_msg': (lambda desc, count: ungettext(
                                ...
                                'You have successfully rebooted %(count)d virtual machines (<b>%(desc)s</b>).',
                                count) % {'desc': desc, 'count': count}),
                            'ask_msg': (lambda desc, count: ungettext(
                                'Do you want to reset virtual machine <b>%(desc)s</b>?.<br /><b>Note!</b> Any unsaved data will be lost!',
                                'Do you want to reset %(count)d virtual machines <b>%(desc)s</b>?.<br /><b>Note!</b> Any unsaved data will be lost!',
                                count) % {'desc': desc, 'count': count}),
                       ...
                       url(r'^ajax/assign_chosen_ip/(?P<id1>\d+)/$', user_permission(form_generic_id),
                           {'template_name': 'vms/ajax/assign_ip.html',
                            'success_msg': (
                            lambda desc, data: _('You have successfully assigned selected IP address.') % {
                                'desc': desc}),
                       ...
                       url(r'^ajax/revoke_chosen_ip/(?P<id1>\d+)/$', user_permission(simple_generic_id),
                           {'template_name': 'generic/simple.html',
                            'success_msg': (
                            lambda desc: _('You have successfully revoked IP address.') % {'desc': desc}),
                       ...
                       url(r'^ajax/edit_vm/(?P<id1>\d+)/$', user_permission(form_generic_id),
                           {'template_name': 'generic/form.html',
                            'success_msg': (
                            lambda desc, data: _('You have successfully edited virtual machine data.') % {
                                'desc': desc}),
                            'confirmation': _('Save'),
                       ...
                       url(r'^ajax/save_and_shutdown/(?P<id1>\d+)/$', user_permission(form_generic_id),
                           {'template_name': 'generic/form.html',
                            ...
                            'ask_msg': (
                            lambda desc: _('Enter a name to save virtual machine <b>%(desc)s</b>:') % {'desc': desc}),
                       ...
                       url(r'^ajax/get_template_list/$', 'vms_ajax_get_template_list',
                           name='vms_ajax_get_template_list'),
