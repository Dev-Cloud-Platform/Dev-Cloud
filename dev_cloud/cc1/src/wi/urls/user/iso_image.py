...
resources_patterns = patterns('wi.views.user.iso_image',
                              ...
                              url(r'^iso/$', user_permission(direct_to_template),
                                  {'template_name': 'resources/iso.html'}, name='res_iso'),
                              url(r'^ajax/iso_table/$', 'res_ajax_get_iso_table', name='res_ajax_get_iso_table'),
                              url(r'^ajax/upload_iso_http/$', 'res_ajax_upload_iso_http',
                                  name='res_ajax_upload_iso_http'),
                              ...
                              url(r'^ajax/delete_iso/(?P<id1>\d+)/$', user_permission(simple_generic_id),
                                  {'template_name': 'generic/simple.html',
                                   'success_msg': (
                                   lambda desc: _('You have successfully removed ISO image <b>%(desc)s</b>.') % {
                                       'desc': desc}),
                                   'ask_msg': (
                                   lambda desc: _('Do you really want to delete ISO image <b>%(desc)s</b>?') % {
                                       'desc': desc}),
