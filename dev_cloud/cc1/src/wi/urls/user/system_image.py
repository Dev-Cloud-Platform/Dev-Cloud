...
images_patterns = patterns('wi.views.user.system_image',
                           url(r'^$', user_permission(direct_to_template), {'template_name': 'images/base.html'},
                               name='img_images'),
                           url(r'^images_private/$', user_permission(direct_to_template),
                               {'template_name': 'images/images_private.html'},
                               name='img_images_private'),
                           url(r'^images_group/$', user_permission(direct_to_template),
                               {'template_name': 'images/images_group.html'},
                               name='img_images_group'),
                           url(r'^images_public/$', user_permission(direct_to_template),
                               {'template_name': 'images/images_public.html'},
                               name='img_images_public'),

                           url(r'^ajax/delete/(?P<id1>\d+)/$', user_permission(simple_generic_id),
                               {'template_name': 'generic/simple.html',
                                'success_msg': (
                                lambda desc: _('You have successfully removed image <b>%(desc)s</b>.') % {
                                    'desc': desc}),
                                'ask_msg': (
                                lambda desc: _('Do you really want to delete image <b>%(desc)s</b>?') % {'desc': desc}),
                                'request_url': 'user/system_image/delete/',
                                'id_key': 'system_image_id',
                                },
                               name='img_ajax_delete'),
                           url(r'^ajax/get_all_table/(?P<img_type>\w+)/$', 'img_ajax_get_all_table',
                               name='img_ajax_get_all_table'),
                           url(r'^ajax/get_private_table/$', 'img_ajax_get_private_table',
                               name='img_ajax_get_private_table'),
                           url(r'^ajax/get_group_table/$', 'img_ajax_get_group_table', name='img_ajax_get_group_table'),
                           url(r'^ajax/get_public_table/$', 'img_ajax_get_public_table',
                               name='img_ajax_get_public_table'),

                           url(r'^ajax/assign_group/(?P<id1>\d+)/$', user_permission(form_generic_id),
                               {'template_name': 'generic/form.html',
                                'success_msg': (lambda desc, data: _(
                                    'You have successfully assigned image <b>%(desc)s</b> to group.') % {'desc': desc}),
                                'ask_msg': (
                                lambda desc: _('Enter a name of group for image <b>%(desc)s</b>.') % {'desc': desc}),
                           ...
                           url(r'^ajax/revoke_group/(?P<id1>\d+)/$', user_permission(simple_generic_id),
                               {'template_name': 'generic/simple.html',
                                'success_msg': (
                                lambda desc: _('You have successfully revoked group\'s assigment.') % {'desc': desc}),
                                'ask_msg': (
                                lambda desc: _('Do you want to make image <b>%(desc)s</b> private?') % {'desc': desc}),
                           ...
                           url(r'^ajax/edit_image/(?P<id1>\d+)/$', user_permission(form_generic_id),
                               {'template_name': 'generic/form.html',
                                'success_msg': (
                                lambda desc, data: _('You have successfully edited this image.') % {'desc': desc}),
                           ...
                           url(r'^ajax/change_to_storage/(?P<id1>\d+)/$', user_permission(simple_generic_id),
                               {'template_name': 'generic/simple.html',
                                'success_msg': (lambda desc: _(
                                    'You have successfully changed image <b>%(desc)s</b> to a storage disk.') % {
                                                                 'desc': desc}),
                                'ask_msg': (
                                lambda desc: _('Do you want to change image <b>%(desc)s</b> to a storage disk?') % {
                                    'desc': desc}),
