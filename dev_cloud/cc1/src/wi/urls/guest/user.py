...
account_patterns = patterns('wi.views.guest.user',
                            ...
                            url(r'^password_change/done/$', direct_to_template,
                                ...
                                name='acc_password_change_done'),
                            url(r'^password_reset_error_token/$', direct_to_template,
                                {'template_name': 'account/password_reset_error_token.html'},
                                name='acc_password_reset_error_token'),

                            url(r'^reset/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$', 'acc_password_reset_confirm',
                                name='acc_password_reset_confirm'),
                            ...
                            url(r'^reset/done/$', direct_to_template,
                                ...
                                name='acc_password_reset_complete'),
                            )
...
registration_patterns = patterns('wi.views.guest.user',
                                 ...
                                 url(r'^register/admin_confirmation/$', direct_to_template,
                                     {'template_name': 'registration/registration_admin_confirmation.html'},
                                     name='registration_admin_confirmation'),
