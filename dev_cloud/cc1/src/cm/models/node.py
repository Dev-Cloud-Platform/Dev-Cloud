...
class Node(models.Model):
    ...
    def cpu_free(self):
        ...
        c = self.vm_set.exclude(state__in=[vm_states['closed'], vm_states['erased']]).aggregate(
    ...
    def memory_free(self):
        ...
        m = self.vm_set.exclude(state__in=[vm_states['closed'], vm_states['erased']]).aggregate(
    ...
    def hdd_free(self):
        ...
        s = self.vm_set.exclude(state__in=[vm_states['closed'], vm_states['erased']]).aggregate(
            size_sum=Sum('system_image__size'))
