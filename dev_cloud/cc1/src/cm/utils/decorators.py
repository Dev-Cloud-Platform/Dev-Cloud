...
def guest_log(*arg, **kw):
    ...
    def logwrapper(fun):
        ...
        def wrapper(*args, **kwargs):
            return genericlog(log_enabled=kw.get('log', False), is_user=False, is_admin_cm=False, need_ip=False,
                              fun=fun, args=args)
...
def user_log(*arg, **kw):
    ...
    def logwrapper(fun):
        @wraps(fun)
        def wrapper(*args, **kwargs):
            return genericlog(log_enabled=kw.get('log', False), is_user=True, is_admin_cm=False, need_ip=False, fun=fun,
                              args=args)
...
def admin_cm_log(*arg, **kw):
    ...
    def logwrapper(fun):
        @wraps(fun)
        def wrapper(*args, **kwargs):
            return genericlog(log_enabled=kw.get('log', False), is_user=True, is_admin_cm=True, need_ip=False, fun=fun,
                              args=args)
...
def ci_log(*arg, **kw):
    ...
    def logwrapper(fun):
        @wraps(fun)
        def wrapper(*args, **kwargs):
            return genericlog(log_enabled=kw.get('log', False), is_user=False, is_admin_cm=False, need_ip=True, fun=fun,
                              args=args)
