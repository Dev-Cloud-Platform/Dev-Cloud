...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'cm_admin', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cm.User'], unique=True,
                                                                              primary_key=True)),
        ...
        db.create_table(u'cm_publicip', (
            ...
            ('user',
             self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='public_ips', null=True,
                                                                   to=orm['cm.User'])),
        ))
        ...
        db.create_table(u'cm_image', (
            ...
            ('storage',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cm.Storage'], null=True, blank=True)),
        ...
        db.create_table(u'cm_vm', (
            ...
            ('iso_image',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cm.Image'], null=True, blank=True)),
            ...
            ('farm',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='vms', null=True, to=orm['cm.Farm'])),
